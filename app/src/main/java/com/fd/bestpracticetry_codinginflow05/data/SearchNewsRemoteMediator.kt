...
//                    SearchResult(searchQuery = searchQuery ,articleUrl =  article.url, queryPosition = queryPosition++)
                ...
                searchQueryRemoteKeyDao.insertRemoteKey(SearchQueryRemoteKey(searchQuery = searchQuery,nextPageKey = nextPageKey))
