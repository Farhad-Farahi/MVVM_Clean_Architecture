...
import com.fd.bestpracticetry_codinginflow05.api.NewsApi
import com.fd.bestpracticetry_codinginflow05.util.Resource
import com.fd.bestpracticetry_codinginflow05.util.networkBoundResource
...
class NewsRepository @Inject constructor(
    ...
    fun getSearchResultsPaged(query : String ,refreshOnInit: Boolean ) : Flow<PagingData<NewsArticle>> =
        Pager(
            ...
            remoteMediator = SearchNewsRemoteMediator(searchQuery = query ,newsApi =  newsApi ,newsArticleDb =  newsArticleDb , refreshOnInit ),
            pagingSourceFactory = {newsArticleDao.getSearchResultArticlesPaged(query = query)}
        ).flow
