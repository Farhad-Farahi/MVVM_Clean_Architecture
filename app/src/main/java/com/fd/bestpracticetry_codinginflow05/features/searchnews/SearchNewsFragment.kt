...
import com.fd.bestpracticetry_codinginflow05.MainActivity
import com.fd.bestpracticetry_codinginflow05.R
import com.fd.bestpracticetry_codinginflow05.databinding.FragmentSearchNewsBinding
import com.fd.bestpracticetry_codinginflow05.shared.NewsArticleListAdapter
import com.fd.bestpracticetry_codinginflow05.util.onQueryTextSubmit
import com.fd.bestpracticetry_codinginflow05.util.showIfOrInvisible
import com.fd.bestpracticetry_codinginflow05.util.showSnackbar
...
@AndroidEntryPoint
class SearchNewsFragment : Fragment(R.layout.fragment_search_news) , MainActivity.OnBottomNavigationFragmentReselectedListener {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        searchView.onQueryTextSubmit { query ->
            viewModel.onSearchQuerySubmit(query = query)
